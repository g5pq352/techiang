	...
	<div class="indexWrap">
			...
			<svg class="ryder-magic" width="622" height="134" viewBox="0 0 622 134">
				...
				<g class="filter-area" style='filter: url("#goo-1");'>
					<g class="picList" mask="url(#news_mask)">
						<image href="images/ib-1.jpg" x="0" y="0" width="100%" height="100%" preserveAspectRatio="xMidYMid slice"></image>
		...
		<section class="index-storyWrap grid-x align-center-middle">
			<div class="title-area cell large-auto flex-container align-center">
				<div class="item1">
					...
					<div class="content">
						德匠名廚成立於1985年，講究與世界潮流同步的生<br class="show-for-large">
						活美學設計概念，從廚房為起點，連貫至整體居家及<br class="show-for-large">
						個人品味的延伸，對於美食藝術的強烈執著
					</div>
				</div>
				<div class="item2">
			...
			<div class="marquee-container cell large-auto">
				...
				<div class="deco-2"><img src="images/story-1.svg"></div>

				<div class="marquee-area grid-x align-top">
					<ul class="marqueeList cell auto">
						<li><img src="images/marquee-1.jpg"></li>
						<li><img src="images/marquee-2.jpg"></li>
						<li><img src="images/marquee-3.jpg"></li>

						<li><img src="images/marquee-7.jpg"></li>
						<li><img src="images/marquee-8.jpg"></li>
					...
					<ul class="marqueeList cell auto">
						<li><img src="images/marquee-4.jpg"></li>
						<li><img src="images/marquee-5.jpg"></li>
						<li><img src="images/marquee-6.jpg"></li>

						<li><img src="images/marquee-9.jpg"></li>
						<li><img src="images/marquee-10.jpg"></li>
						<li><img src="images/marquee-11.jpg"></li>
						<li><img src="images/marquee-12.jpg"></li>
		...
		<section class="index-choicesWrap">
			<div class="title-area">
				...
				<div class="ch">為了獨一無二的你 ,我們準備了不一樣的選擇</div>
			</div>
			<div class="pic"></div>
		</section>
		...
		<div class="index-leichtWrap show-for-large">
			...
			<div class="index-plusWrap grid-x align-center-middle">
				...
				<div class="article-area cell large-shrink">
					<div class="title"><img src="images/story-2.svg"></div>
		...
		<section class="index-serviceWrap">
			...
			<div class="item">
				<div class="bg"><img src="images/index-service.png"></div>
			...
			<div class="shopWrap">
				...
				<section>
					...
					<ul class="shopList">
						...
						<li class="grid-x align-middle">
							<div class="pic-area cell large-shrink">
								<div class="pic"><img src="images/shop-2.jpg"></div>
								<div class="icon"><img src="images/shop-icon-2.svg"></div>
								<div class="block"></div>
							</div>
							<div class="content-area cell large-shrink">
								<div class="title">德匠名廚 美術館分公司</div>
			...
			<div class="item">
				...
				<ul class="index-newsList">
					<li><a href="news_detail.php" class="grid-x align-middle">
						...
						<div class="title">總是低調高雅的瑪德蓮，在萬聖節時也要來搞怪一波</div>
