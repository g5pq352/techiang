...
$query_RecshopY = "SELECT * FROM class_set WHERE c_parent = 'shopY' AND c_active='1' ORDER BY c_sort ASC, c_id DESC";
$RecshopY = $conn->query($query_RecshopY);
$row_RecshopY = $RecshopY->fetch();
$totalRows_RecshopY = $RecshopY->rowCount();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data6" type="text" class="table_data" id="d_data6" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    ...
    $insertSQL = "INSERT INTO data_set (d_title, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_data5, d_data6, d_date, d_active) VALUES (:d_title, :d_content, :d_class1, :d_class2, :d_class3, :d_class4, :d_class5, :d_class6, :d_data1, :d_data2, :d_data3, :d_data4, :d_data5, :d_data6, :d_date, :d_active)";
    ...
    $stat->bindParam(':d_class1', $class1 = 'shop', PDO::PARAM_STR);
    ...
    $insertGoTo = "shop_list.php?selected1=" . $_POST['d_class2'] . "&pageNum=0&totalRows=" . ($_SESSION['totalRows'] + 1) . "&changeSort=1&now_d_id=" . $new_data_num . "&change_num=1";
