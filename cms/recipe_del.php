                                            ...
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php
                                                        do {
                                                            if (!(strcmp($row_RecrecipeC['c_id'], $row_Recrecipe['d_class2']))) {
                                                            echo $row_RecrecipeC['c_title'];
                                                            }
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <?php echo nl2br($row_Recrecipe['d_title']); ?>
                                                    </td>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
    ...
    $deleteGoTo = "recipe_list.php?delchangeSort=1&selected1=" . $G_selected1 . "&selected2=" . $G_selected2;
