...
if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'recipeCover') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='recipeCover' AND";
    $not = $imagesSize['recipeCover']['note'];
    $IWidth = $imagesSize['recipeCover']['IW'];
    $IHeight = $imagesSize['recipeCover']['IH'];
...
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'shopCover') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='shopCover' AND";
    $not = $imagesSize['shopCover']['note'];
    $IWidth = $imagesSize['shopCover']['IW'];
    $IHeight = $imagesSize['shopCover']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'leichtCover') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='leichtCover' AND";
    $not = $imagesSize['leichtCover']['note'];
    $IWidth = $imagesSize['leichtCover']['IW'];
    $IHeight = $imagesSize['leichtCover']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'leichtCoverOne') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='leichtCoverOne' AND";
    $not = $imagesSize['leichtCoverOne']['note'];
    $IWidth = $imagesSize['leichtCoverOne']['IW'];
    $IHeight = $imagesSize['leichtCoverOne']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'leichtCoverTwo') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='leichtCoverTwo' AND";
    $not = $imagesSize['leichtCoverTwo']['note'];
    $IWidth = $imagesSize['leichtCoverTwo']['IW'];
    $IHeight = $imagesSize['leichtCoverTwo']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'leichtCoverThree') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='leichtCoverThree' AND";
    $not = $imagesSize['leichtCoverThree']['note'];
    $IWidth = $imagesSize['leichtCoverThree']['IW'];
    $IHeight = $imagesSize['leichtCoverThree']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'cleanupCover') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='cleanupCover' AND";
    $not = $imagesSize['cleanupCover']['note'];
    $IWidth = $imagesSize['cleanupCover']['IW'];
    $IHeight = $imagesSize['cleanupCover']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'cleanupCoverOne') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='cleanupCoverOne' AND";
    $not = $imagesSize['cleanupCoverOne']['note'];
    $IWidth = $imagesSize['cleanupCoverOne']['IW'];
    $IHeight = $imagesSize['cleanupCoverOne']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'cleanupCoverTwo') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='cleanupCoverTwo' AND";
    $not = $imagesSize['cleanupCoverTwo']['note'];
    $IWidth = $imagesSize['cleanupCoverTwo']['IW'];
    $IHeight = $imagesSize['cleanupCoverTwo']['IH'];
} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'cleanupCoverThree') {
    $type = $_REQUEST['type'];
    $fileType = "file_type='cleanupCoverThree' AND";
    $not = $imagesSize['cleanupCoverThree']['note'];
    $IWidth = $imagesSize['cleanupCoverThree']['IW'];
    $IHeight = $imagesSize['cleanupCoverThree']['IH'];
} else {
    $type = '-1';
    $fileType = "file_type='image' AND";
    $not = $imagesSize[$_SESSION['nowMenu']]['note'];
