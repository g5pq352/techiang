...
$query_RecshopC = "SELECT * FROM class_set WHERE c_parent = 'shopC' ORDER BY c_sort ASC, c_id DESC";
...
if ($G_changeSort == 1 || $G_delchangeSort == 1) {
    ...
    if ($G_changeSort == 1) {
        header("Location:shopC_list.php?pageNum=" . $_GET['pageNum'] . "&totalRows_RecshopC=" . $_GET['totalRows_RecshopC']);
    } else if ($G_delchangeSort == 1) {
        header("Location:shopC_list.php?pageNum=" . $_GET['pageNum']);
    }
}
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    ...
                                    <tr <?php if ($i%2==0): ?>bgcolor='#E4E4E4'<?php endif ?>>
                                        <td align="center" class="table_data">
                                            <select name="c_sort" id="c_sort" onchange="changeSort('<?php echo $pageNum; ?>','<?php echo $totalRows_RecshopC; ?>','<?php echo $row_RecshopC['c_id']; ?>',this.options[this.selectedIndex].value)">
                                            ...
                                            <?php $_SESSION['totalRows']=$totalRows_RecshopC; ?>
                                        </td>
                                        <td align="center" class="table_data">
...
<script type="text/javascript">
    function changeSort(pageNum, totalRows_RecshopC, now_c_id, change_num) {
        window.location.href = "shopC_list.php?pageNum=" + pageNum + "&totalRows_RecshopC=" + totalRows_RecshopC + "&changeSort=1" + "&now_c_id=" + now_c_id + "&change_num=" + change_num;
    }
</script>