...
<?php
if (!1) {
    header("Location: recipeC_list.php");
}
...
$colname_RecrecipeC = "-1";
if (isset($_GET['c_id'])) {
    $colname_RecrecipeC = $_GET['c_id'];
}

$query_RecrecipeC = "SELECT * FROM class_set WHERE c_id = :c_id";

$RecrecipeC = $conn->prepare($query_RecrecipeC);
$RecrecipeC->bindParam(':c_id', $colname_RecrecipeC, PDO::PARAM_INT);
$RecrecipeC->execute();
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title" type="text" class="table_data" id="c_title" value="<?php echo $row_RecrecipeC['c_title']; ?>" size="50" />
                                                                                <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecrecipeC['c_id']; ?>" />
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <input name="c_title_en" type="text" class="table_data" id="c_title_en" value="<?php echo $row_RecrecipeC['c_title_en']; ?>" size="50" />
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="516">
                                                                                <select name="c_active" class="table_data" id="c_active">
                                                                                    <option value="0" <?php if (!(strcmp(0, $row_RecrecipeC[ 'c_active']))) {echo "selected";} ?>>不公佈</option>
                                                                                    <option value="1" <?php if (!(strcmp(1, $row_RecrecipeC[ 'c_active']))) {echo "selected";} ?>>公佈</option>
                                                                                </select>
                                                                            </td>
                                                                            <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                                        </tr>
