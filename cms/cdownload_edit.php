...
$colname_Reccdownload = "-1";
if (isset($_GET['d_id'])) {
    $colname_Reccdownload = $_GET['d_id'];
}

$query_Reccdownload = "SELECT * FROM data_set WHERE d_id = :d_id";
$Reccdownload = $conn->prepare($query_Reccdownload);
$Reccdownload->bindParam(':d_id', $colname_Reccdownload, PDO::PARAM_INT);
$Reccdownload->execute();
$row_Reccdownload = $Reccdownload->fetch();
$totalRows = $Reccdownload->rowCount();
...
$RecImage->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'cdownloadCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
$RecCover->execute();
$row_RecCover = $RecCover->fetch();
$totalRows_RecCover = $RecCover->rowCount();

$query_RecCoverOne = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'cdownloadCoverOne'";
$RecCoverOne = $conn->prepare($query_RecCoverOne);
$RecCoverOne->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
$RecCoverOne->execute();
$row_RecCoverOne = $RecCoverOne->fetch();
$totalRows_RecCoverOne = $RecCoverOne->rowCount();

$query_RecCoverTwo = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'cdownloadCoverTwo'";
$RecCoverTwo = $conn->prepare($query_RecCoverTwo);
$RecCoverTwo->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
$RecCoverTwo->execute();
$row_RecCoverTwo = $RecCoverTwo->fetch();
$totalRows_RecCoverTwo = $RecCoverTwo->rowCount();

$query_RecCoverThree = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'cdownloadCoverThree'";
$RecCoverThree = $conn->prepare($query_RecCoverThree);
$RecCoverThree->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
...
$RecFile->bindParam(':file_d_id', $colname_Reccdownload, PDO::PARAM_INT);
$RecFile->execute();
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="3" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Reccdownload['d_id']; ?>" />
                                                        <input name="d_title" type="text" class="table_data" id="d_title" value="<?php echo $row_Reccdownload['d_title']; ?>" size="60">
                                                    </td>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_data1" cols="60" rows="7" class="table_data" id="d_data1"><?php echo $row_Reccdownload['d_data1']; ?></textarea>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data1" type="text" class="table_data" id="d_data1" value="<?php echo $row_Reccdownload['d_data1']; ?>" size="100">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_data2" cols="60" rows="7" class="table_data" id="d_data2"><?php echo $row_Reccdownload['d_data2']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCoverOne['file_id'].'&type=cdownloadCoverOne'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCoverOne['file_id'].'&type=cdownloadCoverOne'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['cdownloadCoverOne']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data3" type="text" class="table_data" id="d_data3" value="<?php echo $row_Reccdownload['d_data3']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_data3" cols="60" rows="7" class="table_data" id="d_data3"><?php echo $row_Reccdownload['d_data3']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['cdownloadCoverTwo']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_data5" type="text" class="table_data" id="d_data5" value="<?php echo $row_Reccdownload['d_data5']; ?>" size="60">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="d_data4" cols="60" rows="7" class="table_data" id="d_data4"><?php echo $row_Reccdownload['d_data4']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCoverThree['file_id'].'&type=cdownloadCoverThree'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCoverThree['file_id'].'&type=cdownloadCoverThree'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['cdownloadCoverThree']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_class2" type="text" class="table_data" id="d_class2" value="<?php echo $row_Reccdownload['d_class2']; ?>" size="10">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr> -->
                                                <!-- <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td>
                                                        <textarea name="d_content" cols="60" rows="7" class="table_data tiny" id="d_content"><?php echo $row_Reccdownload['d_content']; ?></textarea>
                                                    </td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*小斷行請按Shift+Enter。
                                                            <br /> 輸入區域的右下角可以調整輸入空間的大小。
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo ( ($row_Reccdownload['d_date']=='') || (!(strcmp(" 0000-00-00 00:00:00 ", $row_Reccdownload['d_date']))) ) ? date("Y-m-d H:i:s ") : $row_Reccdownload['d_date']; ?>" size="50">
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td width="532">
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="1" <?php if (!(strcmp(1, $row_Reccdownload[ 'd_active']))) {echo "selected";} ?>>顯示</option>
                                                            <option value="0" <?php if (!(strcmp(0, $row_Reccdownload[ 'd_active']))) {echo "selected";} ?>>不顯示</option>
                                                        </select>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=cdownloadCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=cdownloadCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['cdownloadCover']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="2" id="addF">
                                                            <tr>
                                                                <td height="28">
                                                                    <table border="0" cellspacing="2" cellpadding="2">
                                                                        <tr>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reccdownload['d_id'] ?>" class="fancyboxUpload" title="上傳圖片"><img src="image/add.png" width="16" height="16" border="0"></a></td>
                                                                            <td><a href="dropzoneImg.php?d_id=<?= $row_Reccdownload['d_id'] ?>" class="fancyboxUpload table_data">上傳圖片</a></td>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['image_titleCover'], $menu_is, "add", $imagesSize['cdownloadCover']['IW'], $imagesSize['cdownloadCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'cdownloadCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // CoverOne
    $image_result = image_process($conn, $_FILES['imageCoverOne'], $_REQUEST['image_titleCoverOne'], $menu_is, "add", $imagesSize['cdownloadCoverOne']['IW'], $imagesSize['cdownloadCoverOne']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'cdownloadCoverOne', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // CoverTwo
    $image_result = image_process($conn, $_FILES['imageCoverTwo'], $_REQUEST['image_titleCoverTwo'], $menu_is, "add", $imagesSize['cdownloadCoverTwo']['IW'], $imagesSize['cdownloadCoverTwo']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'cdownloadCoverTwo', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    // CoverThree
    $image_result = image_process($conn, $_FILES['imageCoverThree'], $_REQUEST['image_titleCoverThree'], $menu_is, "add", $imagesSize['cdownloadCoverThree']['IW'], $imagesSize['cdownloadCoverThree']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'cdownloadCoverThree', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "cdownload", "add");
