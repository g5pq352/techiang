...
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="recipeCover")){
    $fileType = "file_type='recipeCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="shopCover")){
    $fileType = "file_type='shopCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="leichtCover")){
    $fileType = "file_type='leichtCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="leichtCoverOne")){
    $fileType = "file_type='leichtCoverOne' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="leichtCoverTwo")){
    $fileType = "file_type='leichtCoverTwo' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="leichtCoverThree")){
    $fileType = "file_type='leichtCoverThree' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="cleanupCover")){
    $fileType = "file_type='cleanupCover' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="cleanupCoverOne")){
    $fileType = "file_type='cleanupCoverOne' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="cleanupCoverTwo")){
    $fileType = "file_type='cleanupCoverTwo' AND";
} else if (isset($_REQUEST['type']) && ($_REQUEST['type']=="cleanupCoverThree")){
