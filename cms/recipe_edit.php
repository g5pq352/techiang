...
$colname_Recrecipe = "-1";
if (isset($_GET['d_id'])) {
    $colname_Recrecipe = $_GET['d_id'];
}

$query_Recrecipe = "SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = :d_id";
$Recrecipe = $conn->prepare($query_Recrecipe);
$Recrecipe->bindParam(':d_id', $colname_Recrecipe, PDO::PARAM_INT);
$Recrecipe->execute();
$row_Recrecipe = $Recrecipe->fetch();
$totalRows_Recrecipe = $Recrecipe->rowCount();

$query_RecImage = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'image'";
$RecImage = $conn->prepare($query_RecImage);
$RecImage->bindParam(':file_d_id', $colname_Recrecipe, PDO::PARAM_INT);
$RecImage->execute();
$row_RecImage = $RecImage->fetch();
$totalRows_RecImage = $RecImage->rowCount();

$query_RecCover = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'recipeCover'";
$RecCover = $conn->prepare($query_RecCover);
$RecCover->bindParam(':file_d_id', $colname_Recrecipe, PDO::PARAM_INT);
$RecCover->execute();
...
$RecrecipeC = $conn->prepare($query_RecrecipeC);
$RecrecipeC->execute();
$row_RecrecipeC = $RecrecipeC->fetch();
$totalRows_RecrecipeC = $RecrecipeC->rowCount();

$query_RecFile = "SELECT * FROM file_set WHERE file_d_id = :file_d_id AND file_type = 'file'";
$RecFile = $conn->prepare($query_RecFile);
$RecFile->bindParam(':file_d_id', $colname_Recrecipe, PDO::PARAM_INT);
$RecFile->execute();
$row_RecFile = $RecFile->fetch();
$totalRows_RecFile = $RecFile->rowCount();

$G_selected1 = '';
if (isset($_SESSION['selected_recipeC'])) {
    $G_selected1 = $_SESSION['selected_recipeC'] = $row_Recrecipe['d_class2'];
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="5" cellspacing="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_class2" id="d_class2" class="chosen-select">
                                                            <?php do { ?>
                                                                <option value="<?php echo $row_RecrecipeC['c_id']?>" <?php if (!(strcmp($row_RecrecipeC[ 'c_id'], $row_Recrecipe[ 'd_class2']))) {echo "selected";} ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea name="d_title" cols="60" rows="6" class="table_data" id="d_title"><?php echo $row_Recrecipe['d_title']; ?></textarea></td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">英文標題</td>
                                                    <td>
                                                        <input name="d_title_en" type="text" class="table_data" id="d_title_en" value="<?php echo $row_Recrecipe['d_title_en']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <!-- <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class3" type="text" class="table_data" id="d_class3" value="<?php echo $row_Recrecipe['d_class3']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class4" type="text" class="table_data" id="d_class4" value="<?php echo $row_Recrecipe['d_class4']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class5" type="text" class="table_data" id="d_class5" value="<?php echo $row_Recrecipe['d_class5']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_class6" type="text" class="table_data" id="d_class6" value="<?php echo $row_Recrecipe['d_class6']; ?>" size="80" />
                                                    </td>
                                                    <td bgcolor="#e5ecf6"> </td>
                                                </tr> -->
                                                <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">材料</td>
                                                    <td class="table_data"><textarea name="d_data1" cols="100" rows="20" class="table_data tiny" id="d_data1"><?php echo $row_Recrecipe['d_data1']; ?></textarea></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_data"><textarea name="d_data2" cols="100" rows="20" class="table_data" id="d_data2"><?php echo $row_Recrecipe['d_data2']; ?></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr>
                                                <!-- <tr>
                                                    <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                                                    <td class="table_data"><textarea name="d_content" cols="100" rows="20" class="table_data tiny" id="d_content"><?php echo $row_Recrecipe['d_content']; ?></textarea></td>
                                                    <td bgcolor="#e5ecf6" class="table_col_title"><p class="red_letter">*小斷行請按Shift+Enter。<br />
                                                    輸入區域的右下角可以調整輸入空間的大小。</p></td>
                                                </tr> -->
                                                <!-- <tr>
                                                    ...
                                                    <td class="table_data">
                                                        <div class="perm" id="perm_1">
                                                            <label for="r1">
                                                                <input name="perm_coffee" type="radio" id="r1" value="1" <?php if ($row_Recrecipe['d_data1'] == 1): ?>checked<?php endif ?>> 拉鍊窗簾
                                                            </label>
                                                            <label for="r2">
                                                                <input name="perm_coffee" type="radio" id="r2" value="2" <?php if ($row_Recrecipe['d_data1'] == 2): ?>checked<?php endif ?>> 拼拼簾
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recrecipe['d_date']; ?>" size="50" />
                                                    </td>
                                                    <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="d_active" class="table_data" id="d_active">
                                                            <option value="0" <?php if (!(strcmp(0, $row_Recrecipe[ 'd_active']))) {echo "selected";} ?>>不公佈</option>
                                                            <option value="1" <?php if (!(strcmp(1, $row_Recrecipe[ 'd_active']))) {echo "selected";} ?>>公佈</option>
                                                        </select>
                                                    </td>
                                                    <td bgcolor="#e5ecf6">&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecCover['file_id'].'&type=recipeCover'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecCover['file_id'].'&type=recipeCover'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                                                                <td align="center">&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#e5ecf6" class="table_col_title">
                                                        <p class="red_letter">*
                                                            <?php echo $imagesSize['recipeCover']['note'];?>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <?php } // Show if recordset not empty ?>
                                ...
                                <input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recrecipe['d_id']; ?>" />
                                <input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recrecipe['d_sort']; ?>" />
                            </form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
    ...
    // Cover
    $image_result = image_process($conn, $_FILES['imageCover'], $_REQUEST['imageCover_title'], $menu_is, "add", $imagesSize['recipeCover']['IW'], $imagesSize['recipeCover']['IH']);
    ...
    for ($j = 1; $j < count($image_result); $j++) {
        ...
        $stat->bindParam(':file_link2', $image_result[$j][2], PDO::PARAM_STR);
        $stat->bindParam(':file_link3', $image_result[$j][3], PDO::PARAM_STR);
        $stat->bindParam(':file_type', $type = 'recipeCover', PDO::PARAM_STR);
        $stat->bindParam(':file_d_id', $_POST['d_id'], PDO::PARAM_INT);
        $stat->bindParam(':file_title', $image_result[$j][4], PDO::PARAM_STR);
        $stat->bindParam(':file_show_type', $image_result[$j][5], PDO::PARAM_INT);
        $stat->execute();
    ...
    if ($ifFile) {
        $file_result = file_process($conn, "recipe", "add");
    ...
    $_SESSION['original_selected'] = $_SESSION['selected_recipeC'];

    $updateGoTo = "recipe_list.php?selected1=" . $_POST['d_class2'] . "&changeSort=1&change_num=" . $_POST['d_sort'] . "&now_d_id=" . $_POST['d_id'] . "&totalRows=" . $_SESSION['totalRows'] . "&pageNum=" . $_SESSION["ToPage"];
